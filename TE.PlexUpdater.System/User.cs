...
namespace TE.PlexUpdater.System
{
    public class User
    {
        ...
        #region Constructors
        /// <summary>
        /// Creates an instance of the <see cref="User"/> class.
        /// </summary>
        /// <exception cref="WindowsUserSidNotFoundException">
        ...
        /// <summary>
        /// Creates an instance of the <see cref="User"/> class when provided
        /// with the Windows user's name.
        /// </summary>
        /// <exception cref="WindowsUserSidNotFoundException">
        /// Thrown when the SID for the user is null or empty.
        /// </exception>		
        ...
        private string GetLocalAppDataFolder()
        {
            ...
            {
                throw new WindowsUserSidNotFoundException(
            ...
            foreach (string keyName in key.GetSubKeyNames())
            {
                ...
                if (sidKey != null)
                {
                    ...
                    if (profilePath.IndexOf(name, StringComparison.OrdinalIgnoreCase) >= 0)
                    {
                        ...
                        // the SID
                        sid = Path.GetFileName(sidKey.Name);
