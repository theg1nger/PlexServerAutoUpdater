...
namespace TE.PlexUpdater.System.Msi
{
    ...
    public static class Api
    {
        ...
        /// </summary>
        /// <returns>
        /// A List of strings containing all component GUIDs.
        /// </returns>        
        ...
        /// </summary>
        /// <returns>
        /// A List of strings containing all GUIDs.
        /// </returns>
        public static List<string> EnumerateProducts()
        {
            ...
            do
            {
                ...
                object dummy1;
                ret = MsiEnumProductsEx(null, null, (uint)InstallContext.All, i, guid, out dummy1, null, ref dummy2);
                if (ret == 0)
                {
                    guidList.Add(guid);
                }
        ...
        public static string GetComponentPathByFile(string fileName)
        {
            ...
            do
            {
                ...
                // Get a component GUID
                returnValue = MsiEnumComponents(i, guid);

                // If the return code indicates a success, then add the GUID
                // to the list
                if (returnValue == (uint)MsiExitCodes.Success)
                {
            ...
            } while ((returnValue != (uint)MsiExitCodes.NoMoreItems) && (path.Length == 0));

            return path;
        }

        /// <summary>
        /// Get property of a product indicated by GUID. Throws exception if
        ...
        public static String GetProperty(string productGUID, string propertyName)
        {
            ...
            // Get the data length
            MsiGetProductInfo(productGUID, propertyName, null, ref length);

            // increase for the terminating \0
            length++;

            String value = new string(new char[length]);
            int returnValue = 
                MsiGetProductInfo(
                    productGUID,
                    propertyName,
